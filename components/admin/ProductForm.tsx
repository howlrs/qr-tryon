            ...
            <div className="bg-white border border-border rounded-xl p-6 shadow-sm space-y-4">
                ...
                <div className="space-y-4">
                    {variants.map((variant, index) => (
                        <div key={index} className="grid grid-cols-1 sm:grid-cols-6 lg:grid-cols-12 gap-4 items-start p-4 bg-muted/30 rounded-lg border border-border/50">
                            ...
                            <div className="col-span-1 sm:col-span-6 lg:col-span-1 pt-6 flex sm:justify-end">
                                {variants.length > 1 && (
                                    <button
                                        type="button"
