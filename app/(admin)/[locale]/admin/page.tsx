                ...
                <table className="w-full text-left text-sm">
                    <thead className="bg-muted/50 border-b border-border">
                        <tr>
                            ...
                            <th className="px-6 py-4 font-medium text-muted-foreground">{t('variants')}</th>
                            <th className="px-6 py-4 font-medium text-muted-foreground">{t('price')}</th>
                            <th className="px-6 py-4 font-medium text-muted-foreground">{t('stock')}</th>
                        ...
                        {products.map((product) => {
                            ...
                            return (
                                <tr key={product.id} className="hover:bg-muted/20 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-muted-foreground">{product.variants.length} {t('variants')}</td>
